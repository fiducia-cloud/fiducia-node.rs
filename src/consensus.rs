...
use crate::state::{
    ...
    ServiceInstance, TaskState, EffectState, HandoffState,
...
impl ReadRequest {
    ...
    pub fn routing_key(&self) -> &str {
        match self {
            ...
            ReadRequest::Barrier { name } | ReadRequest::Task { name } | ReadRequest::Effect { name } | ReadRequest::Handoff { name } => name,
